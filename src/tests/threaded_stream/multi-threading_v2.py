"""
Version of streaming multiple RTSP cameras using, PyQt, threads, and openCV.
This version of code was taken from a stack overflow question and is work in 
progress to get running in my current environment


- Issues with using QT platform were solved by running:
...
if __name__ == '__main__':
    ...
    # Stream links
    camera0 = 'rtsp://{}:{}@disc-cam2.iot.nau.edu:554/2'.format(username, password)
    camera1 = 'rtsp://{}:{}@disc-cam3.iot.nau.edu:554/2'.format(username, password)
    #camera0 = 'rtsp://{}:{}@disc-cam2.iot.nau.edu:554/cam/realmonitor?channel=1&subtype=0'.format(username, password)
    #camera1 = 'rtsp://{}:{}@disc-cam3.iot.nau.edu:554/cam/realmonitor?channel=1&subtype=0'.format(username, password)
